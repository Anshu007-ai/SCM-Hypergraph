...
import ParetoVisualiser from './components/ParetoVisualiser';
...
const NAV_ITEMS = [
  ...
  { id: 'indigo-timeline', label: '📅 Case Study' },
...
const DATASETS_FULL = [
  ...
  },
  {
    ...
    description: 'Global maritime shipping port infrastructure dataset tracking disruption events across 847 ports worldwide. Models how port congestion propagates through shipping corridors and temporal disruption patterns.',
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-16">
        {[
          ...
          },
          {
            ...
            example: 'E.g., Downstream disruption at logistic hubs takes 3-5 days to detect and quantify.'
          },
          {
            icon: Network,
            stat: '3.6×',
          ...
          <GlassCard hover={false} className="border border-accent-blue/20">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                { label: 'Criticality', icon: Shield, color: '#EF4444', desc: 'Low / Med / High / Critical', metric: 'HIGH', loss: '4-class CE', example: 'Port congestion criticality: HIGH (0.95 conf)' },
